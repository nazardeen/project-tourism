...
public class TraningModelGenarator {
    ...
    public static void generateModel() throws IOException {
        ...
        File file = ResourceUtils.getFile("src/main/resources/recommendation-traning-data.txt");
        ...
        try (OutputStream modelOut = new BufferedOutputStream(
                new FileOutputStream("src/main/resources/nlp-model/en-trained-modelnew.bin"))) {
